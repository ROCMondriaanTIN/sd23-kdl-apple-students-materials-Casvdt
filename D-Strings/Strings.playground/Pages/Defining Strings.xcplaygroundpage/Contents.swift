/*:
## Defining Strings
In the Naming and Identifiers playground, you declared number constants like this:
 */
...
let favoriteMovie = "Jumanji welcome to the jungle"
// Declare a favoriteSong constant
let favoriteSong = "Fight song"
/*:
