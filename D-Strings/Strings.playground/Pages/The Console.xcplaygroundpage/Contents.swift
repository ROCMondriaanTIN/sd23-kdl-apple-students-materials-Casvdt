...
### Showing the Console
 Show the console by clicking this button in the bottom right of the Xcode window:

 ![Console Button](console_button.png)

 The console is part of the Debug area, which you can show by choosing **View > Debug Area > Show Debug Area** from the menu or by pressing **Shift-Command-Y** (**Shift-⌘-Y**).

 ![Debug Area menu](view-show-debug-menu.png)
