...
/*:
You get an error because Swift thinks the string definition is finished at the second quotation mark, just before the `Hi`. After that, it doesn’t know how to interpret the rest of the line of code.
...
[Previous](@previous)  |  page 11 of 18  |  [Next: Escape Sequences](@next)
 */
